...
- **Из за глюков накатки патча перед его применением создайте каталог test (из корня проекта путь \src\test) <a href="https://drive.google.com/open?id=0B9Ye2auQ_NsFanBONjJPMzVkZzA">3 Add Junit.patch</a>.**
